...
public class RegisterTransportActivity extends AppCompatActivity {
    ...
    Boolean check()
    {
        return !txtNumberPhoneReceiver.getText().toString().isEmpty() && !txtAddressReceiver.getText().toString().isEmpty() && !txtReceiverName.getText().toString().isEmpty() &&
                !txtNameItem.getText().toString().isEmpty() && !txtUnit.getText().toString().isEmpty() && !txtWeight.getText().toString().isEmpty();
    }
    ...
    void loadControll()
    {
        ...
        txtLoaiHH = findViewById(R.id.txtLoaiHH);
    ...
    void  getData()
    {
        ...
        lstDV = new ArrayList<String>();
        lstDV.add("Cái");
        lstDV.add("Chiếc");
        lstDV.add("Thùng") ;
        ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(context, android.R.layout.simple_spinner_item,lstDV);
        AutoCompleteTextView autoCompleteTV = findViewById(R.id.txtUnit);
        autoCompleteTV.setAdapter(adapter3);
